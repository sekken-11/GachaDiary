<template>
  <v-btn block class="mb-3 p-2" color="info" @click="toCreate">
    換算用データ 作成
  </v-btn>
      ...
      <div class="pt-2 px-4">
        <ul class="text-end mb-0">
          <button
            ...
            @click="handleOpenDetail(initialPackage)"
          >
            詳細
          </button>
        </ul>
  ...
  <div id="packages" class="bg-white rounded shadow p-3 mb-3">
    ...
    <div
      v-for="(userAddPackage, index) in userAddPackages"
    ...
    >
      ...
      <div class="pt-2 px-4">
        <ul class="text-end mb-0">
          <button class="btn btn-sm btn-outline-info me-2" @click="handleOpenDetail(userAddPackage)">
            詳細
          </button>
          <button class="btn btn-sm btn-outline-success me-2" @click="toEdit(userAddPackage.id)">
            編集
          </button>
          <button class="btn btn-sm btn-outline-danger" @click="handleOpenDelete(userAddPackage)">
            削除
          </button>
        </ul>
      </div>
